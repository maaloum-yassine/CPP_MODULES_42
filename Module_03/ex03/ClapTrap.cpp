...
/*   Updated: 2024/05/20 02:16:18 by ymaaloum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
		std::cout << "Initialize constructor called ClapTrap " << _name << " is created [^_^] "<< std::endl;
}
...
void		ClapTrap ::	beRepaired(unsigned int amount)
{
	if (this->_point_energy && this->_point_health)
	{
			std::cout << this->_name << " healed " << amount << " point." << std::endl;
	...
	else
	{
		if (!this->_point_health)
			...
			std::cout << this->_name << " is not have energy points!" << std::endl;
	}
}
...
void		ClapTrap ::	takeDamage(unsigned int amount)
{
	if (this->_point_health)
	{
		...
		{
			std::cout << this->_name << " Suffered " << this->_point_health  << " point of damage!" << std::endl;
...
ClapTrap :: ~ClapTrap ()
{
	std::cout << "Destructor called ClapTrap " << _name <<  "is destroyed [^_^]" << std::endl;
}
